...
counterpart_zh: ../../zh/01_long_context/bamboo.md
---

# BAMBOO

[English Knowledge Base Index](../README.md) | [中文卡片](../../zh/01_long_context/bamboo.md)
...
| Paper Title | BAMBOO: A Comprehensive Benchmark for Evaluating Long Text Modeling Capacities of Large Language Models |
| Chinese Card | [BAMBOO](../../zh/01_long_context/bamboo.md) |

## Overview

A contamination-aware long-text benchmark spanning QA, hallucination detection, ranking, language modeling, and code completion.
...
| Type | Link |
|---|---|
| Paper | https://arxiv.org/abs/2309.13345 |
