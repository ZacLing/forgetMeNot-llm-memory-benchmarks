...
counterpart_zh: ../../zh/01_long_context/ada-leval.md
---

# Ada-LEval

[English Knowledge Base Index](../README.md) | [中文卡片](../../zh/01_long_context/ada-leval.md)
...
| Chinese Card | [Ada-LEval](../../zh/01_long_context/ada-leval.md) |

## Overview

A length-adaptable benchmark with TSort and BestAnswer for controllable long-context evaluation.
...
| Type | Link |
|---|---|
| Paper | https://aclanthology.org/2024.naacl-long.205/ |
