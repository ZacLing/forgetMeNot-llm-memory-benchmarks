...
counterpart_en: ../../en/01_long_context/helmet.md
---

# HELMET

[中文知识库索引](../README.md) | [English Card](../../en/01_long_context/helmet.md)
...
| 英文卡片 | [HELMET](../../en/01_long_context/helmet.md) |
...
- 当需要比较模型在更真实、更多样的长上下文任务族上的表现时，HELMET 比单一 NIAH 风格测试更有代表性。
