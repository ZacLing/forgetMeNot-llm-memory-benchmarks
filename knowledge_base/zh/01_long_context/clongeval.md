...
counterpart_en: ../../en/01_long_context/clongeval.md
---

# CLongEval

[中文知识库索引](../README.md) | [English Card](../../en/01_long_context/clongeval.md)
...
| 英文卡片 | [CLongEval](../../en/01_long_context/clongeval.md) |
...
- 若研究对象是中文 long-context 能力，CLongEval 通常比直接套用英文 benchmark 更贴近目标场景。
